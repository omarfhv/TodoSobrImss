...
public class CalcClausulaNoventySiete extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_clausula_noventy_siete);
        this.setTitle("Prestamo clausula 97");
        ...
        tvResultado3.setVisibility(View.INVISIBLE);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSumar:
                try {
                    ...
                    tvResultado3.setVisibility(View.VISIBLE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.item1).setIcon(getResources().getDrawable(R.drawable.modifica));
    ...
    private void documents() {
        ...
        View vista = getLayoutInflater().inflate(R.layout.dialogo_documentos_clausula, null);
    ...
    private void instruccionesdialogo() {
        ...
        txv.setText(getResources().getString(R.string.instruccionesclausula97));
        botonok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialogo.cancel();
