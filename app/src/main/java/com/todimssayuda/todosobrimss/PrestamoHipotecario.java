...
public class PrestamoHipotecario extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prestamo_hipotecario);
        ...
        switch (view.getId()){
            ...
            case R.id.btnSumar:
                try {
                    ...
                    double resultado3 = (resultado)*150;
                    DecimalFormat formato = new DecimalFormat("$00,000.00");
                    tvResultado.setText("SU CREDITO HIPOTECARIO ES = " + formato.format(resultado3));
    ...
    private void instruccionesdialogo(boolean def) {
        ...
        if (!sharedPref.getBoolean("instruccionesa", false) || def) {
            ...
            View vista = getLayoutInflater().inflate(R.layout.infohipotecario, null);
