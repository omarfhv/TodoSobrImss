...
public class CalcPrestamoMedianoPlazo extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    EditText et1, et2;
    Button btnSumar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_prestamo_mediano_plazo);
        this.setTitle("Credito hipotecario M.P.");
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSumar:
                try {
                    ...
                    double resultado3 = (resultado) * 70;
                    DecimalFormat formato = new DecimalFormat("$00,000.00");
                    tvResultado.setText("SU CREDITO HIPOTECARIO DE MEDIANO PLAZO = " + formato.format(resultado3));
                    tvResultado.setVisibility(View.VISIBLE);
                } catch (NumberFormatException e) {
                    Toast.makeText(getApplicationContext(),
                            "Favor de Ingresar todos los conceptos correctamente", Toast.LENGTH_LONG).show();
                    return;
                }
                break;
        }
    ...
    private void instruccionesdialogo() {
        ...
        txvt.setText(getResources().getString(R.string.instruccioneshipotecariomedianoplazo));
