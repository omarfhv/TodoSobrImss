...
public class CalcProporcionalAguinaldo extends AppCompatActivity {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_proporcional_aguinaldo);
        this.setTitle("Calc proporcional aguinaldo");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            startActivity(new Intent(getBaseContext(), CalcAguinaldo.class)
