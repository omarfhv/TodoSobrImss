...
public class Permutas extends AppCompatActivity {
    // AdView mAdView;
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            webview.setWebChromeClient(new WebChromeClient() {
                public void onProgressChanged(WebView view, int progress) {
                    ...
                    Permutas.this.setProgress(progress * 1000);
                }
            });
            ...
            botonsi.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.setClass(Permutas.this, Permutas.this.getClass());
                            //llamamos a la actividad
                            Permutas.this.startActivity(intent);
                            //finalizamos la actividad actual
                            Permutas.this.finish();
                        }
                    }
            );
    ...
    private void validaPermisos() {
        ...
        if ((shouldShowRequestPermissionRationale(READ_EXTERNAL_STORAGE)) ||
            ...
            AlertDialog.Builder dialogo = new AlertDialog.Builder(Permutas.this);
