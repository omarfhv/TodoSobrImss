...
public class CalcVac extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvprima.setVisibility(View.INVISIBLE);
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSumar:
                try {
                    ...
                    tvprima.setVisibility(View.VISIBLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                startActivity(new Intent(getBaseContext(), MenuCalcVacaciones.class)
