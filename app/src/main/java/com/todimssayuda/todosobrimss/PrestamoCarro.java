...
public class PrestamoCarro extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prestamo_carro);
    ...
    private void instruccionesdialogo(boolean def) {
        ...
        if (!sharedPref.getBoolean("instruccionesa", false) || def) {
            ...
            View vista = getLayoutInflater().inflate(R.layout.instruccarro, null);
