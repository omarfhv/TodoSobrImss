...
public class AnticipodeAguinaldo extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState)   {
        ...
        setContentView(R.layout.activity_anticipode_aguinaldo);
        ...
        switch (view.getId()) {
            ...
            case R.id.btnSumar:
                try {
                    ...
                    double resultado = ((aux1 + aux2) * 6)/3;
                    double resultado2 = ((aux1 + aux2) * 6)-(resultado);
                    DecimalFormat formato1 = new DecimalFormat("$0,000.00");
                    DecimalFormat formato = new DecimalFormat("$00,000.00");
                    tvResultado.setText("Su Anticipo de AGUINALDO es de =  " + formato.format(resultado));
                    tvResultado2.setText("Su AGUINALDO aproximado despues del Anticipo sería = " + formato1.format(resultado2));
