...
public class Aguinaldo extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.btnpropocional:
                Intent intentdajaa = new Intent(this, ProporcionalAguinaldo.class);
    ...
    private void instruccionesdialogo(boolean def) {
        ...
        if (!sharedPref.getBoolean("instruccionesa", false) || def) {
            ...
            View vista = getLayoutInflater().inflate(R.layout.instruccionesaguinaldo, null);
