...
public class CajaAhorro extends AppCompatActivity {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            webview.setWebChromeClient(new WebChromeClient() {
                public void onProgressChanged(WebView view, int progress) {
                    ...
                    CajaAhorro.this.setProgress(progress * 1000);
                }
            });
            ...
            webview.loadUrl("https://www.cpasntss.mx/");
            ...
            botonsi.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            intent.setClass(CajaAhorro.this, CajaAhorro.this.getClass());
                            //llamamos a la actividad
                            CajaAhorro.this.startActivity(intent);
                            //finalizamos la actividad actual
                            CajaAhorro.this.finish();
                        }
                    }
            );
    ...
    private void validaPermisos() {
        ...
        if ((shouldShowRequestPermissionRationale(READ_EXTERNAL_STORAGE)) ||
            ...
            AlertDialog.Builder dialogo = new AlertDialog.Builder(CajaAhorro.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menupromo, menu);
