...
public class PrestamoMedianoPlazo extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prestamo_mediano_plazo);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.infohipotecario, menu);
    ...
    private void instruccionesdialogo(boolean def) {
        ...
        if (!sharedPref.getBoolean("instruccionesa", false) || def) {
            ...
            View vista = getLayoutInflater().inflate(R.layout.infomediano, null);
