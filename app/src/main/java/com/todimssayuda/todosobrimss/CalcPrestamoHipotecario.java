...
public class CalcPrestamoHipotecario extends AppCompatActivity implements View.OnClickListener {
    AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calc_prestamo_hipotecario);
        this.setTitle("Prestamo hipotecario");
    ...
    private void instruccionesdialogo() {
        ...
        txvt.setText(getResources().getString(R.string.requisitoscreditohipotecario));
